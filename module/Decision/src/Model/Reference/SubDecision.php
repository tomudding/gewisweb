...
namespace Decision\Model\Reference;
...
use Decision\Model\Reference\SubDecision\Abrogation;
use Decision\Model\Reference\SubDecision\Annulment;
use Decision\Model\Reference\SubDecision\Board\Discharge as BoardDischarge;
use Decision\Model\Reference\SubDecision\Board\Installation as BoardInstallation;
use Decision\Model\Reference\SubDecision\Board\Release as BoardRelease;
use Decision\Model\Reference\SubDecision\Discharge;
use Decision\Model\Reference\SubDecision\Financial\Budget;
use Decision\Model\Reference\SubDecision\Financial\Statement;
use Decision\Model\Reference\SubDecision\Foundation;
use Decision\Model\Reference\SubDecision\FoundationReference;
use Decision\Model\Reference\SubDecision\Installation;
use Decision\Model\Reference\SubDecision\Key\Granting as KeyGranting;
use Decision\Model\Reference\SubDecision\Key\Withdrawal as KeyWithdrawal;
use Decision\Model\Reference\SubDecision\Minutes;
use Decision\Model\Reference\SubDecision\OrganRegulation;
use Decision\Model\Reference\SubDecision\Other;
use Decision\Model\Reference\SubDecision\Reappointment;
