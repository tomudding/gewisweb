 ...
 *
 * - {@see self::IfFullBefore}: draw at a given moment, regardless of fullness -- when the list is oversubscribed by
 *   then it is a real lottery; when it is not, everyone so far is admitted and the locked list hands out its
 *   remaining places first-come-first-served.
