...
class SignupList
{
    ...
    /**
     * The moment the automated draw is due for this list, or null when it is never drawn automatically: unlimited
     * lists, manual allocation methods, and a conditional draw without a cutoff rule (impossible through the form,
     * possible for legacy rows) have no draw moment. First-come-first-served draws at close; a conditional draw at
