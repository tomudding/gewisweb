 ...
 * moment), the one-shot lock, the audit stamp (a member for manual, null for automated) and the refusal to touch
 * manual-allocation lists. Dates are pinned explicitly per scenario, so nothing depends on seed freshness.
 *
